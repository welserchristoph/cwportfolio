    ...
    >
      <div className="text-center mb-10">
        ...
        <div className="flex flex-wrap gap-2">
            <span className="bg-orange-400 text-black px-2 py-1 rounded text-sm">DOP</span>
            <span className="bg-orange-400 text-black px-2 py-1 rounded text-sm">Editor</span>
        </div>
      </div>
